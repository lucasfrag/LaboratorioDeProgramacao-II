...
import br.com.senacrs.lab2.monetizacao.entidades.Usuario;
...
public class UsuarioDAO {
	...
	public void salvar (Usuario usuario) {
		try {
			...
			String sql = "INSERT INTO usuarios (cpf, nome, login, senha) VALUES (?,?,?)";
			...
			prepara.setString(3, usuario.getLogin()); 
			...
			System.out.println("Erro ao cadastrar o usuário no banco.");
			e.printStackTrace();
		}
	}
